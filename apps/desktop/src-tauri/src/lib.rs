...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::add_ncr_lot_link,
            commands::remove_ncr_lot_link,
            ...
            commands::execute_wi_step,
            commands::get_wi_step_status,
            commands::approve_wi_step,
            commands::validate_lot_step_order,
            // Test commands
            commands::list_tests,
            commands::get_test,
            ...
            commands::add_work_instruction_step,
            commands::remove_work_instruction_step,
            commands::add_work_instruction_tool,
            commands::remove_work_instruction_tool,
            commands::add_work_instruction_material,
            commands::remove_work_instruction_material,
            commands::add_work_instruction_quality_check,
            commands::remove_work_instruction_quality_check,
            commands::set_work_instruction_safety,
            commands::clear_work_instruction_safety,
            // Supplier commands
